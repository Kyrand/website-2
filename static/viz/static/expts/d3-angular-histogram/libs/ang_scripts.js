...
var BaseApp = angular.module('BaseApp', [
    ...
    .config(function ($routeProvider) {
        $routeProvider
            ...
            .when('/bar-demo', {
                templateUrl: '/static/views/barchart-demo.html',
                controller: 'NBDemoCtrl'
            })
            .when('/hist-demo', {
                templateUrl: '/static/views/hist-demo.html',
                controller: 'NBDemoCtrl'
            })
            .when('/bar-hist-demo', {
                templateUrl: '/static/views/bar-hist-demo.html',
                controller: 'NBDemoCtrl'
            })
            .when('/upload-demo', {
                templateUrl: '/static/views/upload-demo.html',
                controller: 'NBDemoCtrl'
            })
            .when('/css3-demo', {
                templateUrl: '/static/views/css3-demo.html',
                controller: 'NBDemoCtrl'
            })
            .when('/multivar-demo', {
                templateUrl: '/static/views/multivar-demo.html',
                controller: 'NBDemoCtrl'
            })
            .when('/spreadsheet-demo', {
                templateUrl: '/static/views/spreadsheet-demo.html',
                controller: 'NBDemoCtrl'
            })
            .otherwise({
                redirectTo: '/'
